 ...
 */
final class Version20200813065331 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN user_users.date_of_creation IS \'(DC2Type:datetime_immutable)\'');
